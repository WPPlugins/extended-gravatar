...
*/
	...
	"show_throbber": function() {
		...
		if ( !Gravatar.throbber ) {
			Gravatar.throbber = jQuery( '<div id="grav-throbber" style="position: absolute; z-index: 16"><img src="' + extended_gravatar_url + '/images/throbber.gif" alt="." width="15" height="15" /></div>' );
		}
	...
	"fetch_profile_by_hash": function( hash, dom_id ) {
		...
		Gravatar.stat( 'fetch' );
		this.load_js( extended_gravatar_url + '/gravatar-fetch.php?hash=' + hash, function() {
